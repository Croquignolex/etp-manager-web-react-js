    ...
    return (
        <ConnectedRouter history={history}>
            <Switch>
                ...
                {/* Checkouts */}
                <RestrictedRouteContainer exact path={path.HANDING_OVER_PAGE_PATH} component={asyncComponent(() => import('./containers/checkout/CheckoutHandoversPageContainer'))} />
                ...
                {/* Operations */}
                <RestrictedRouteContainer exact path={path.OPERATIONS_TRANSFERS_PAGE_PATH} component={asyncComponent(() => import('./containers/operations/OperationsTransfersContainer'))} />
                {/* Other pages */}
