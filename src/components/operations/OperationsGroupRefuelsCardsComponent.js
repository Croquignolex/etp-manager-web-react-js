...
// Component
function OperationsGroupRefuelsCardsComponent({refuels, handleGroupConfirmModalShow, handleGroupDetailsModalShow}) {
    // Local states
...
OperationsGroupRefuelsCardsComponent.propTypes = {
...
export default React.memo(OperationsGroupRefuelsCardsComponent);
