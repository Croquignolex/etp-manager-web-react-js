...
// Component
function RecoveriesFleetsAddRecoveryComponent({request, vendors, dispatch, handleClose, allVendorsRequests}) {
    // Local state
...
RecoveriesFleetsAddRecoveryComponent.propTypes = {
...
export default React.memo(RecoveriesFleetsAddRecoveryComponent);
